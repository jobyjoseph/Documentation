...
While preparing the images to be uploaded for a product, following points should be kept in mind.

- Product images to be uploaded should be either in .jpg, .tif or .gif format. .jpg is recommended.
- The product image should be in colour. Black and white image is not accepted.
- The product image should take at least 85% of the total image area.
- Line drawings of a product are not permitted. Only actual photos are allowed.
- Every image that is uploaded should have sRGB colour mode.
- The product image should not have any borders, text, watermarks or information.
- The product image should be in a plain white background.
- The image should have atleast 500px in its longest side. 1001px is the ideal length. Upto 3000px length is allowed. To enable zooming of product image, the image should have at least 2560px in its longest side.
- The image should show one angle of the product. The image should not combine multiple angles in one image.
- The store logo should be 120x30px in dimension.

Every product in Amazon requires one or more images. The primary image of your product is termed "MAIN". That image appears in search and browse pages. Also in product details page, the MAIN image is shown as the first image.
