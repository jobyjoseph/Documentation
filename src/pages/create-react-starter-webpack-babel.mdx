...
import imageJestError from "../images/articles/2020/react-starter-component.png";

<Layout>
<SEO title="Create React Starter App using React 16, Webpack 4 and Babel 7" />
<JSLayout>
...
- We need __Node.js__ and __NPM__ to install and run packages used in our project.
- __package.json__ file stores the project dependecies.
...
- __Webpack__ is a bundler which creates a single bundle file which contains all our project dependencies.
...
- __Babel__ can be used with webpack using `babel-loader`.
- We specify the presets used by babel inside `.babelrc` file which is located at project root.
- __HtmlWebpackPlugin__ is a webpack plugin which can dynamically create our deployable html file with reference to bundle.js file.
