...
<Layout>
<SEO title="Next.js Interview Questions - Routing, Dynamic Routes, Catch-All Routes" />
<JSLayout>
...
<Image src={imagePagesFolder} style={{maxWidth: "200px", display: "block", margin: "auto"}} alt="Next.js Pages folder" />
...
<Image src={imageSameURLPagesFolder} style={{maxWidth: "160px", display: "block", margin: "auto"}} alt="Next.js Same url Pages folder" />
