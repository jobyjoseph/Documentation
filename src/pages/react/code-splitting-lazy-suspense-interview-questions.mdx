...
<Layout>
<SEO title="React Code-Splitting, Lazy, Suspense Interview Questions" />
<JSLayout>
...
TODO: related to default exports. Lazy will work only with components with default exports
