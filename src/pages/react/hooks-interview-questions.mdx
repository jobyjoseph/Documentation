...
<Disqus config={{url: "https://backbencher.dev/react/hooks-interview-questions", identifier: props.pageContext.frontmatter.id, title: props.pageContext.frontmatter.title,}} />
