...
<Layout>
<SEO title="Numeric Separators in JavaScript" />
<JSLayout>

# Numeric Separators in JavaScript <Version number="12" />
...
<Disqus config={{url: "https://backbencher.dev/javascript/numeric-separators", identifier: props.pageContext.frontmatter.id, title: props.pageContext.frontmatter.title,}} />
