...
import imageGlobalThisBrowser from "../../images/articles/2020/globalthis-browser.png";
import imageGlobalThisNode from "../../images/articles/2020/globalthis-nodejs.png";

<Layout>
<SEO title="globalThis in JavaScript" />
<JSLayout>
...
<Image src={imageGlobalThisBrowser} alt="globalThis in Browser" caption="globalThis value in browser" />

Here is the browser in Nodejs.
<Image src={imageGlobalThisNode} alt="globalThis in Nodejs" caption="globalThis value in Node.js" />
