...
import imgPromiseAnyError from "../../images/articles/2020/promise-any-error.png";
...
This article is updated on **Mar 13, 2021** based on <Olink link="https://github.com/tc39/ecma262/releases/tag/es2021-candidate-2021-03">ES2021 Release Candidate</Olink>. The features listed in the release needs to be approved by ECMA General Assembly on June 2021. That is when the features actually be a part of the standard.
...
<div className="inArticleAdContainer">
  <GoogleAds slot="9195558466" />
</div>
...
<Image src={imgPromiseAnyError} style={{maxWidth: "500px", display: "block", margin: "auto"}} alt="AggregateError" />
...
<Link to="/javascript/numeric-separators">Read more on Numeric Separator</Link>


<Disqus config={{url: "https://backbencher.dev/javascript/es2021-new-features", identifier: props.pageContext.frontmatter.id, title: props.pageContext.frontmatter.title,}} />
