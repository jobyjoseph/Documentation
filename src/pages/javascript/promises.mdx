...
import imagePromiseAllSettled from "../../images/articles/2020/promise-allsettled.png";


<Layout>
<SEO title="Promises in JavaScript" />
<JSLayout>
...
<Image src={imagePromise} alt="Contents of promise instance" caption="Contents of promise instance" style={{maxWidth: "300px"}}/>
...
<Image src={imagePromiseAllSettled} alt="Promise.allSettled()" caption="Output: Promise.allSettled()" style={{maxWidth: "400px"}}/>
