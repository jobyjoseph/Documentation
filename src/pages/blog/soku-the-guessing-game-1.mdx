...
import imgDoneWithItUpdatedWelcome from "../../images/articles/2020/donewithit-updated-welcome.jpg";
import imgDoneWithItDetailsScreen from "../../images/articles/2020/donewithit-details-screen.jpg";
import imgDoneWithItAddedIcons from "../../images/articles/2020/donewithit-added-icons.jpg";
import imgDoneWithItFlatIcons from "../../images/articles/2020/donewithit-flatlist.jpg";
import imgDoneWithItFlatListSeparator from "../../images/articles/2020/donewithit-flatlist-separator.jpg"
import imgDoneWithItSwipeListItem from "../../images/articles/2020/donewithit-swipe-listitem.jpg"
...
I learned how to insert icons from expo set. Then created a reusable button to be used in the tutorial app's welcome screen.

Total time: **6.5 hours**

### Day 9 - Jul 27, 2020

Today, I modified the welcome screen of _DoneWithIt_ app. I used `blurRadius` property of `ImageBackground`. Also other common things like padding, margin, text transform were also used.

<Image src={imgDoneWithItUpdatedWelcome} style={{maxWidth: "300px", display: "block", margin: "auto"}} alt="Donewithit updated welcome screen" />

I also created a reusable app button which is used for Login and Register buttons.

Total time: **7 hours**

### Day 10 - Jul 28, 2020

Today I created a details screen with user profile information.

<Image src={imgDoneWithItDetailsScreen} style={{maxWidth: "300px", display: "block", margin: "auto"}} alt="Donewithit details screen" />

Total time: **7.5 hours**

### Day 11 - Jul 29, 2020

Today I completed the section about styling after working on it for couple of days. I got to know about 3 sites which can boost productivity through custom components.
...
I started with the **Lists** section in tutorial. First list learned was **FlatList**.
<div style={{display: "flex", justifyContent: "center"}}>
<Image src={imgDoneWithItAddedIcons} style={{maxWidth: "300px", margin: "10px"}} alt="Donewithit icons screen" />
<Image src={imgDoneWithItFlatIcons} style={{maxWidth: "300px", margin: "10px"}} alt="Donewithit icons screen" />
</div>
...
- `ItemSeparatorComponent` in `FlatList` to bring separators between list items
- `TouchableHighlight` on each list item for a highlight effect on pressing an item

<Image src={imgDoneWithItFlatListSeparator} style={{maxWidth: "300px", display: "block", margin: "auto"}} alt="Donewithit details screen" />
...
- `TouchableWithoutFeedback` with delete icon to delete a list item
- In order to show delete icon on swiping a list item to left, `Swipeable` component is used from `react-native-gesture-handler/Swipeable`

<Image src={imgDoneWithItSwipeListItem} style={{maxWidth: "300px", display: "block", margin: "auto"}} alt="Donewithit swipe list item" />
